...
tmuxSeshCommand=""
tmuxSeshCommand="${tmuxSeshCommand} sleep 2 && reset && TELOXIDE_TOKEN=$1 ESP8266_ADDRESS_PORT=$2 SYRINX_VARS=$3 SNOWDOG_VARS=$4 THINKPADX1_VARS=$5 RPI5_VARS=$6 RPI3_VARS=$7"
